package com.iamslash.exkafka.kafka;
...
public class MessageListener {
  ...
  @KafkaListener(topics = "${com.iamslash.exkafka.greeting.topic.name}", containerFactory = "greetingKafkaListenerContainerFactory")
  public void greetingListener(Greeting greeting) {
    System.out.println("Recieved com.iamslash.exkafka.greeting message: " + greeting);
